...
class MPI_particles:
    ...
    def pRHS(self,t,coord,us,sump):
        ...
        self.interpmat = self.interp_cosine(coord,us) #! Interpmat has u,us and c => 2*d+1 components.
        
        
        self.rhs[:,:self.d] = self.interpmat
        self.rhs[:,self.d:2*self.d] *= 0.0 
